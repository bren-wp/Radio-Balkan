...
U 0.0.24 donji transport izlaže i stvarni Stop hit target, a žanrovski `Prikaži sve` affordance otvara postojeći genre selector umjesto da ostane samo dekorativan tekst.
