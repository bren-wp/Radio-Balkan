...
def main() -> None:
    ...
    require(
        ...
        "Prepare optional Windows signing",
        "RADIO_BALKAN_WINDOWS_PFX_B64",
        "RADIO_BALKAN_WINDOWS_PFX_PASSWORD",
        "Import-PfxCertificate",
        "Build signed-or-explicitly-unsigned Windows release",
        "-RequireSignature",
        "Remove Windows signing material",
        "RADIO_BALKAN_WINDOWS_CERT_THUMBPRINT",
        "Verify Windows build leaves repository clean",
        "Verify browser build leaves repository clean",
        "Verify Android build leaves repository clean",
