...
def main() -> int:
    ...
    require(errors, windows, 'home := cachedHomeDiscovery(columns)', "Windows cached home catalog")
    require(errors, windows, 'func cachedHomeDiscovery(columns int) HomeDiscoveryCache', "Windows cached home catalog")
    require(errors, windows, 'func buildHomeDiscoverySnapshot(stations []RadioStation, columns int, revision uint64) HomeDiscoveryCache', "Windows cached home catalog")
    require(errors, windows, 'func rankedStationIndices(stations []RadioStation', "Windows bounded home ranking")
    require(errors, windows, 'catalogRevision', "Windows catalog revision")
    ...
    for needle in (
        ...
        '"Sve Pop & Rock"',
        'case "croatia":',
        'hovered(hitTab, -1, "country:"+item.Code)',
        'hovered(hitTab, -1, "genre:"+item.Value)',
        "func clearSearchForNavigation()",
        "procSetWindowText.Call(uintptr(edit)",
        "func sidebarRowContains(y, rowY int32) bool",
        "hovered(actionKind, -1, actionValue)",
