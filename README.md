...
<p align="center">
  <img alt="version 0.0.44" src="assets/badges/version.svg">
...
- **Dodatno zaključan Pause → Resume race** — zakašnjeli Pause fallback Stop provjerava i media i control generation tek nakon što dobije audio backend lock, pa ne može ugasiti noviji Resume.
- **Pending Play više ne može ostaviti UI u loading stanju** — cleanup koji stvarno očisti pending generation uvijek zakazuje završni repaint i vraća ispravne Play/Stop hit-regije.
...
Gotovi v0.0.44 artefakti objavljuju se izravno kroz [GitHub Releases](https://github.com/bren-wp/Radio-Balkan/releases/tag/v0.0.44):
