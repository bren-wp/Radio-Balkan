...
<p align="center">
  <img alt="version 0.0.18" src="assets/badges/version.svg">
...
Gotovi v0.0.18 artefakti objavljuju se izravno kroz [GitHub Releases](https://github.com/bren-wp/Radio-Balkan/releases/tag/v0.0.18):
...
```bash
python scripts/bump_version.py 0.0.19
```
